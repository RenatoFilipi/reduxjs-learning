...
const Navbar = () => {
  return (
    <>
      {/* Modal - Start */}
      <input type="checkbox" id="disclaimer-modal" className="modal-toggle" />
      <div className="modal">
        <div className="modal-box">
          <h3 className="font-bold text-lg">Attention!</h3>
          <p className="py-4">
            This project is a simple study of redux with some practical examples
            of the technology.
          </p>
          <div className="modal-action">
            <label htmlFor="disclaimer-modal" className="btn btn-primary">
              Close
            </label>
          </div>
        </div>
      ...
      <div className="navbar bg-base-100 border px-10">
        ...
        <div className="justify-end w-full lg:w-2/4">
          ...
          <ul className="hidden lg:flex justify-center items-center gap-7">
            <li>
              {" "}
              <a
                href="https://github.com/RenatoFilipi/reduxjs-learning"
                target="_blank"
